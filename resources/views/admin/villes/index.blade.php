                ...
                <div class="h-100" style="height:100%!important;">
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($villes as $ville)
                            <!-- Modals-->
                                {{-- View Modal --}}
                                <div class="modal fade" id="{{'view_modal_'.$ville->id}}">
                                    <div class="modal-dialog">
                                        <div class="modal-content bg-normal">
                                            <div class="modal-header bg-sombre">
                                                <h4 class="modal-title">{{$ville->name}}</h4>
                                            ...
                                            <div class="modal-footer bg-sombre">
                                                <div class="container d-flex justify-content-between">
                                                    <span>
                                                        <a href="#" class="btn btn-warning" data-toggle="modal" data-target="{{'#edit_modal_'.$ville->id}}" data-dismiss="modal">Editer</a>
                                                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="{{'#delete_modal_'.$ville->id}}" data-dismiss="modal">
                                                            Supprimer
                                                        </a>
                                                    </span>
                                                    <span>
                            ...
                            {{--  --}}
                            {{-- Edit Modal --}}
                                <div class="modal fade" id="{{'edit_modal_'.$ville->id}}">
                                    <div class="modal-dialog">
                                        <div class="modal-content bg-normal">
                                            <div class="modal-header bg-sombre">
                                                <h4 class="modal-title">{{$ville->name}}</h4>
                                            ...
                                            <div class="modal-body">
                                                {!!Form::open(['action' => ['VillesController@update', $ville->id], 'method' => 'POST'])!!}
                                                    <div class="form-group">
                                                        {{Form::label('name', 'Nom de la ville')}}
                                                        {{Form::text('name', $ville->name, ['class' => 'form-control', 'required', 'autofocus'])}}
                                                    </div>
                                                    <div class="form-group">
                                                        {{Form::label('description', 'Description de la ville')}}
                            ...
                            {{-- Delete confirmation --}}
                                <div class="modal fade" id="{{'delete_modal_'.$ville->id}}">
                                    <div class="modal-dialog">
                                        <div class="modal-content bg-normal">
                                            <div class="modal-header bg-sombre">
                                            ...
                                            <div class="modal-body">
                                                Vous allez supprimer la ville {{$ville->name}}
                                            </div>
                                            <div class="modal-footer bg-sombre">
                                                <div class="container d-flex justify-content-between">
                                                    <a href="#">
                                                        {!! Form::open(['action' => ['VillesController@destroy', $ville->id], 'method'=>'POST', 'style' => 'display:inline']) !!}
                                                            {{Form::hidden('_method', 'DELETE')}}
                                                            {{Form::submit('Supprimer', ["class" => "btn btn-danger"])}}
                                                        {!! Form::close() !!}
                                                    </a>
                                                    <a href="{{url('/dashboard/villes')}}" class="btn btn-success" data-dismiss="modal">Non</a>
                                                    <a href="#" class="btn bg-warning" data-toggle="modal" data-dismiss="modal" data-target="{{'#edit_modal_'.$ville->id}}">
                                                        Modifier
                                                    </a>
                                                </div>
                                            </div>
                        ...
                        <tr>
                            <td><?= $i ?><?php $i++; ?></td>
                            <td>
                                <a href="/dashboard/villes/{{$ville->id}}" data-toggle="modal" data-target="{{'#view_modal_'.$ville->id}}" class="link_">
                                    {{-- <script>
                            ...
                            <td colspan="" class="text-right">
                                <!-- <div class="d-flex justify-content-around"> -->
                                        <a href="/dashboard/villes/{{$ville->id}}" class="btn btn-success" data-toggle="modal" data-target="{{'#view_modal_'.$ville->id}}">
                                            <i class="fa fa-eye"></i>Voir
                                        </a>
                                    <span>
                                        <a href="/dashboard/villes/{{$ville->id}}/edit" class="btn btn-warning" data-toggle="modal" data-target="{{'#edit_modal_'.$ville->id}}">
                                            <i class="fa fa-pencil"></i>Modifier
                                        </a>
                                        <a href="#" class="btn btn-danger" data-dismiss="modal" data-toggle="modal" data-target="{{'#delete_modal_'.$ville->id}}">
                                            Supprimer
                                        </a>
                                    </span>
                                <!-- </div> -->
            ...
            <div class="modal-content bg-normal">
                ...
                <div class="modal-body">
                    {!! Form::open(['action' => 'VillesController@store', 'method' => 'POST']) !!}
                        <div class="form-group">
                            {{Form::label('name', 'Nom')}}
                            {{Form::text('name', '', ['class' => 'form-control', 'placeholder' => 'Nom de la ville', 'required', 'autofocus'])}}
                        </div>
                        <div class="form-group">
